...
class CameraCaptureActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (com.example.login.utility.PermissionUtils.hasCameraPermission(this)) startCamera()
        else com.example.login.utility.PermissionUtils.requestCameraPermission(this, CAMERA_PERMISSION_REQUEST_CODE)
    }
    ...
    override fun onRequestPermissionsResult(
        ...
        if (grantResults.isNotEmpty() && grantResults[0] == android.content.pm.PackageManager.PERMISSION_GRANTED) {
            ...
            com.example.login.utility.PermissionUtils.showSettingsDialog(
                this,

...
import com.example.selfieAttendance.api.ApiClient
import com.example.selfieAttendance.api.ApiService
...
import com.example.selfieAttendance.utility.CheckNetworkAndInternetUtils
...
import com.example.selfieAttendance.utility.AutoSyncWorker
...
class FaceRegistrationActivity : AppCompatActivity() {
        ...
        if (requestCode == CAMERA_PERMISSION_REQUEST_CODE) {
            if (grantResults.isNotEmpty() && grantResults[0] == android.content.pm.PackageManager.PERMISSION_GRANTED) {
                ...
                if (!androidx.core.app.ActivityCompat.shouldShowRequestPermissionRationale(this, android.Manifest.permission.CAMERA)) {
                    com.example.selfieAttendance.utility.PermissionUtils.showSettingsDialog(this, "Camera permission is required to capture photos for registration. Please enable it in the app settings.")
                } else {
    ...
    private fun handleActionClick() {
        try {
            ...
            if (!com.example.selfieAttendance.utility.PermissionUtils.hasCameraPermission(this)) {
                com.example.selfieAttendance.utility.PermissionUtils.requestCameraPermission(this, CAMERA_PERMISSION_REQUEST_CODE)
                return
            }

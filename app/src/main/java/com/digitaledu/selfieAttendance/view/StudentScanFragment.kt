...
import com.example.`selfie-attendance`.ml.ActiveLivenessVerifier
        ...
        if (requestCode == 101) {
            if (grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                if (!shouldShowRequestPermissionRationale(Manifest.permission.CAMERA)) {
                    com.example.selfieAttendance.utility.PermissionUtils.showSettingsDialog(this, "Camera permission is required for student face scanning. Please enable it in the app settings.") {

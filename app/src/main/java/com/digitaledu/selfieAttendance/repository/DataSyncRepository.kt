package com.example.selfieAttendance.repository
...
import com.example.selfieAttendance.db.entity.*
import com.example.selfieAttendance.utility.TripleDESUtility
...
class DataSyncRepository(context: Context) {
    ...
    suspend fun fetchDeviceDataToServer(
        ...
        val dataParam = (context as? com.example.selfieAttendance.view.SelectInstituteActivity)?.getDeviceUtilityQueryParams(context)
            ?: return@withContext false

...
class CameraCaptureActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (com.digitaledu.selfieattendance.utility.PermissionUtils.hasCameraPermission(this)) startCamera()
        else com.digitaledu.selfieattendance.utility.PermissionUtils.requestCameraPermission(this, CAMERA_PERMISSION_REQUEST_CODE)
    }
